      ...
      <CardHeader>
        ...
        <CardAction>
          <ToggleGroup
            ...
            value={timeRange}
            onValueChange={(value) => {
              if (Array.isArray(value) && value[0]) setTimeRange(value[0])
            }}
            variant="outline"
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        <ChartContainer config={chartConfig} className="aspect-auto h-[250px] w-full">
          <AreaChart data={filteredData}>
            ...
            <ChartTooltip
              cursor={false}
              content={<ChartTooltipContent labelFormatter={(v) => new Date(v).toLocaleDateString("en-US", { month: "short", day: "numeric" })} indicator="dot" />}
            />
